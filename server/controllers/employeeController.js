...
const getEmployees = async (req, res) => {
    try {
        ...
        return res.status(200).json({success: false, error: "get employees server error"})
    }
}
...
const fetchEmployeesByDepId = async(req, res) => {
    ...
    try {
        ...
        return res.status(200).json({success: false, error: "get employeesByDepId server error"})
    }
}
