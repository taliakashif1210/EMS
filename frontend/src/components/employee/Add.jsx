      ...
      <form onSubmit={handleSubmit}>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            ...
            <div>
                ...
                onChange={handleChange} placeholder="Insert Email" 
            ...
            <div>
                ...
                <input type="file" name="image" onChange={handleChange}  placeholder="Upload Image" 
                accept='image/*' className='mt-1 p-2 block w-full border border-gray-300 rounded-md'/>
            </div>
        </div>
